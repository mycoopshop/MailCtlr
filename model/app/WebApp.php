...
class WebApp extends App {
	...
	##
	public function render($data=array(),$action=NULL,$theme=NULL) {			
		## Cast data as object 
		$data = (object) $data;		
	...
	##
	public function render_view($data=array(),$action=NULL) {
	...
	public function render_theme($data=array(),$theme=null) {
		## Cast $data as object
		$data = (object) $data;		
		## Themes
	...
	function setSessionUser($id, $name, $role, $full_name="") {
		$hash = md5(__FILE__);
		$role = is_array($role) && count($role)>0 ? $role : array("public"); 
		$user = array(
			"name"      => $name,
            "full_name" => $full_name,
			"role"      => $role,
	...
	public static function updateUrlParams($url,$params=array()) {		
